...
const ChangePassword = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:8082/api/changePassword", {
        method: "POST",
        headers: {
              ...
              <ul>
                ...
                <li className="first">
                  <a
                    ...
                    href="/account?action=reviewOrders"
                  >
                    Xem lại đơn hàng
                  </a>
                </li>
          ...
          <div className="col_1_1">
            <div id="login" className="frm_content">
              ...
              <form onSubmit={handleSubmit}>
                <div className="input">
                  <label htmlFor="acc_oldPass">
                    <span className="req">*</span>Mật khẩu cũ:
                  </label>
                  <input
                    name="oldPass"
                    value={oldPass}
                ...
                <div className="input">
                  <label htmlFor="acc_confirmPass">
                    <span className="req">*</span>Xác nhận:
                  </label>
                  <input
                    name="confirmPass"
                ...
                <button id="btn-save" type="submit" className="button">
                  Lưu
                </button>
              </form>
            </div>
