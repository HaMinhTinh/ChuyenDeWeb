    ...
    const fetchProductDetail = async () => {
      try {
        ...
        const response = await fetch(
          `http://127.0.0.1:8082/api/products/detailProduct/${id}`
        );
        if (response.ok) {
              ...
              <div className="product-detail-container">
                ...
                <div className="product-info-container">
                  ...
                  <p className="product__price">
                    Giá:{" "}
                    <span>
                      <CurrencyFormatter value={productDetail.price} /> VNĐ{" "}
                    </span>
                  </p>
                    ...
                    >
                      <form className="form" onSubmit={submitHandler}>
                        ...
                        <button
                          ...
                          onMouseOver={(e) =>
                            (e.target.style.background = "#3a9e36")
                          }
                          onMouseOut={(e) =>
                            (e.target.style.background = "#4BB543")
                          }
                        >
                          Gửi
                        </button>
